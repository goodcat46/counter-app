...
const { PageTransactions, PageError, PageNotFound } = AppPages;
    ...
    <>
      <Routes>
        ...
        <Route path="/" element={<AppGridPage path="transactions" />} errorElement={<PageError />}>
          <Route index element={<PageTransactions path="transactions" />} errorElement={<PageError />} />
          <Route path="transactions" element={<PageTransactions path="transactions" />} errorElement={<PageError />} />
        </Route>
